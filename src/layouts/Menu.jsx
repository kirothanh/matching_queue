          ...
          <ul className="font-medium flex flex-1 flex-col gap-y-3">
            ...
            <li className="p-2">
              ...
              <ul className="-mx-2 mt-2 space-y-1">
                <li>
                  <a href="#!" className="flex items-center p-2 text-gray-500 rounded-full group hover:bg-gray-100">
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border bg-white text-gray-400 border-gray-200 group-hover:text-gray-900">#</span>
                    <span className="truncate text-gray-400 ml-2 group-hover:text-gray-900">FC</span>
                  </a>
                </li>
              </ul>
            </li>
            <li className="flex flex-row items-center mt-auto pb-2">
              <a href="/login" className="w-full">
                <button className="flex p-2 text-gray-500 rounded-lg dark:text-white group hover:bg-gray-100 w-full">
                  ...
                  <span className="ml-3 whitespace-nowrap text-[#6b717e] group-hover:text-gray-900">Đăng nhập</span>
                </button>
              </a>
            </li>
          </ul>
